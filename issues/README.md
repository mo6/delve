...
| [DELVE-0020](archive/DELVE-0020-declare-and-substitute-variables.md) | Declare and substitute translatable pack variables | story | medium | implemented | 1.37.0 |
...
| [DELVE-0084](archive/DELVE-0084-dont-resume-a-stale-abandoned-run-after-completion.md) | Don't offer to resume a stale abandoned run once the pack has since been completed | bug | low | implemented | 1.36.1 |
